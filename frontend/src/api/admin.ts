...
// their own Profile — Deezer, Qobuz, and Tidal. Kept as an array (not a
// single boolean) so more providers can be added later without another
// settings shape change — see backend/src/services/settings.ts's
// HQ_USER_PROVIDERS.
