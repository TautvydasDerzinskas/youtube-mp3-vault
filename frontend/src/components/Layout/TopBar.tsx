...
// usePageBack) sits at the true left edge of the bar, opposite the
// Import/Bell/UserMenu cluster, replacing what used to be a full row each
// page spent on its own inline back button.
