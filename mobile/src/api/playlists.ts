...
export interface CloseHqCandidate {
  ...
  // only ever set for a Deezer candidate right now (see web's own
  // CloseHqCandidate/DeezerSearchResult doc comments for why the other
  // providers don't have one available this cheaply).
