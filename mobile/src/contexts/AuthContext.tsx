...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const setQobuzHqEnabled = useCallback(async (enabled: boolean) => {
  ...
  return (
    <AuthContext.Provider
      value={{
        ...
        updateLanguage, updateProfile, disconnectLastfm, setScrobbling, setAutoDeleteNonMusic, setQobuzHqEnabled,
      }}
    >
      {children}
    </AuthContext.Provider>
